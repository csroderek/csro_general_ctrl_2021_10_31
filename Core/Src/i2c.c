...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(TH_SCL1_GPIO_Port, TH_SCL1_Pin);

    HAL_GPIO_DeInit(TH_SDA1_GPIO_Port, TH_SDA1_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(TH_SDA2_GPIO_Port, TH_SDA2_Pin);

    HAL_GPIO_DeInit(TH_SCL2_GPIO_Port, TH_SCL2_Pin);
